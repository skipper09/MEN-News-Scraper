$.getJSON("/results", function (data) {
    ...
    if (data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) {
            $("#results").append("<div class='article-div mx-auto'><p>" + data[i].title + "</p><a href='" + data[i].link + "'>" + data[i].link + "</p></a><button data-id='" + data[i]._id + "' class='btn btn-sm save-result index-button float-right clearfix mr-4'>Save Article</button></div>")
